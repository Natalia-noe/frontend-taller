  ...
  template: `
    <div class="app-auth-page">
      <mat-card class="app-auth-card">
        ...
        <mat-card-content>
          <p class="auth-hint">
            Ingresá tu <strong>usuario</strong> y contraseña para acceder al panel.
          </p>
          <form [formGroup]="form" (ngSubmit)="submit()">
            ...
            <div class="auth-actions">
              <button mat-flat-button color="primary" type="submit" [disabled]="busy">Ingresar al panel</button>
            </div>
          </form>
          <p class="auth-footer">
            ¿Aún no tenés cuenta?
            <a routerLink="/auth/register">Registrá tu taller</a>
          </p>
        </mat-card-content>
      </mat-card>
    </div>
